...
>(({ className, children, side = 'right', ...props }, ref) => (
  <SheetPortal>
    ...
    <SheetPrimitive.Content
      ref={ref}
      className={cn(
        'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 sm:max-w-lg',
        side === 'left' && 'inset-y-0 left-0 h-full w-3/4 border-r sm:w-1/3 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left',
        side === 'right' && 'inset-y-0 right-0 h-full w-3/4 border-l sm:w-1/3 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right',
